...
public class WeatherContract {
    ...
    //Base URI of the content authority
    public static final String CONTENT_AUTHORITY="com.example.android.sunshine.app";
    public static final Uri BASE_CONTENT_URI=Uri.parse("content://"+CONTENT_AUTHORITY);

    //The path to different table
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        //Indicate whether the Uri contains an item or a list of items
    ...
    public static final class LocationEntry implements BaseColumns{
        ...
        //Indicate whether the cursor contains an item or a list of items
        public static final String CONTENT_TYPE =
        ...
        //location code
        public static final String COLUMN_LOCATION="location_code";
        ...
        public static Uri buildLocationUri(long id){
            return ContentUris.withAppendedId(CONTENT_URI,id); //append the id to the url
        }
